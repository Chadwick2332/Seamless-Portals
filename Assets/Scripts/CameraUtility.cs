...
/* CameraUtility is used to gather the positions of the GetScreenRectFromBounds
 * of the texture relative to the main camera. We can then use that create a
 * clip plane for object infront of the portal camera.
 */
